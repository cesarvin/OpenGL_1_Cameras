...
import numpy as np
                     ...
                     # VERTS           COLOR
rectVerts = np.array([ 0.5, 0.5, 0.5,  0.5,1,0.5, 
                      ...
                      -0.5, 0.5,-0.5,  0.5,0.3,0.5 ], dtype=np.float32)
...
class Renderer(object):
    ...
    def rollCube(self, grades):
        self.cubeRoll = grades

    def pitchCube(self, grades):
        self.cubePitch = grades
    
    def yawlCube(self, grades):
        self.cubeYawl = grades
    ...
    def render(self):
        ...
        pitch = glm.rotate(i, glm.radians( self.cubePitch ),  glm.vec3(1,0,0))
        yaw   = glm.rotate(i, glm.radians( self.cubeYawl ), glm.vec3(0,1,0))
        roll  = glm.rotate(i, glm.radians( self.cubeRoll ), glm.vec3(0,0,1))
